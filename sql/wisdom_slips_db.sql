...
(
  ...
  COLLATE = utf8mb4_unicode_ci COMMENT ='功能点';
...
/*!40000 ALTER TABLE `function_point`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `function_point`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  AUTO_INCREMENT = 10000
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='项目分析';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  AUTO_INCREMENT = 10000
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='子系统';
/*!40101 SET character_set_client = @saved_cs_client */;
...
VALUES (10000, 'Admin', '$2a$10$.aQ6lx8vZSeY7xmWASqUq.L/2v2CZQdtxPVVigJkcCPAHyM5y2i2G', 0, 0, 1, NULL, 0, NULL, NULL,
